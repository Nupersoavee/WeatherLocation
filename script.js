document.getElementById("getWeatherButton").addEventListener("click", function() {
    ...
    const apiKey = "YOUTAPIKEYHERE";
    
    const cityInput = document.getElementById("cityInput").value;

    // If the user entered a city name, use it to get the weather
    if (cityInput) {
        getWeatherByCity(cityInput, apiKey);
    } else {
        // If no city name entered, try to get weather based on location
...
function getWeatherByCity(city, apiKey) {
    // Make an API request to OpenWeatherMap using the provided city name
